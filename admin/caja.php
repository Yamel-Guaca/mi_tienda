...
<<<<<<< HEAD
    ...
    // --- NUEVO: calcular gastos dentro del rango usando DATETIME (fecha + hora) ---
...
// Re-ejecutar consultas de resumen si no hubo cierre (usar rango de la sesión abierta si existe)
